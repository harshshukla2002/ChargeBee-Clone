...
document.querySelector("#annual").addEventListener("click",function(){
    document.querySelector("#div2-amount").innerText="249/mo";
    document.querySelector("#div3-amount").innerText="549/mo";
    document.querySelector("#bill1").innerText="billed annually";
    document.querySelector("#bill2").innerText="billed annually";
    document.querySelector("#bill3").innerText="billed annually";
    document.querySelector("#bill4").innerText="billed annually";
})

document.querySelector("#monthly").addEventListener("click",function(){
    document.querySelector("#div2-amount").innerText="299/mo"
    document.querySelector("#div3-amount").innerText="599/mo"
    document.querySelector("#bill1").innerText="";
    document.querySelector("#bill2").innerText="";
    document.querySelector("#bill3").innerText="";
    document.querySelector("#bill4").innerText="";
})

document.querySelector("#pay1").addEventListener("click",function(){
    let money=parseInt( document.querySelector("#div2-amount").innerText);
    localStorage.clear("money")
    localStorage.setItem("money",JSON.stringify(money))
    window.location.href="payment.html";
})

document.querySelector("#pay2").addEventListener("click",function(){
    let money=parseInt(document.querySelector("#div3-amount").innerText)
    localStorage.clear("money")
    localStorage.setItem("money",JSON.stringify(money))
    window.location.href="payment.html";
})