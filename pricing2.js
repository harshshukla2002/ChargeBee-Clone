...
document.querySelector("#annual").addEventListener("click",function(){
    document.querySelector("#launch").innerText="249/mo";
    document.querySelector("#rise").innerText="549/mo";
...
document.querySelector("#monthly").addEventListener("click",function(){
    document.querySelector("#launch").innerText="299/mo"
    document.querySelector("#rise").innerText="599/mo"
...
document.querySelector("#pay1").addEventListener("click",function(){
    let money= parseInt(document.querySelector("#launch").innerText);
...
document.querySelector("#pay2").addEventListener("click",function(){
    let money=parseInt(document.querySelector("#rise").innerText)
    localStorage.removeItem("money")
    localStorage.setItem("money",JSON.stringify(money))
    window.location.href="payment.html";
})